...
if uploaded_file is not None:
    ...
    # user_list.remove('Bss ek saal or')# to remove group notification
    user_list.sort()
    ...
    if st.sidebar.button("Show Analysis"):
        num_messages, words, num_media_messages, num_links,num_stickers=helper.fetch_stats(selected_user,df)
